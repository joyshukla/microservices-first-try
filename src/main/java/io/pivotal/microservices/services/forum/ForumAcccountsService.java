 ...
 */
@Service
public class ForumAcccountsService {
    ...
    protected Logger logger = Logger.getLogger(ForumAcccountsService.class.getName());

    public ForumAcccountsService(String serviceUrl) {
